...
# Shell Shock - Changelog Plugin

A **Shell Shock** plugin that displays version changelog details to the user through the console.
...
```bash
pnpm add -D @shell-shock/plugin-changelog
```
...
```bash
npm install -D @shell-shock/plugin-changelog
```
...
```bash
yarn add -D @shell-shock/plugin-changelog
```
