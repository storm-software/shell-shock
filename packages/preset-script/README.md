...
```bash
pnpm add -D @shell-shock/preset-script
```
...
```bash
npm install -D @shell-shock/preset-script
```
...
```bash
yarn add -D @shell-shock/preset-script
```
...
Run `nx build preset-script` to build the library.

## Running unit tests

Run `nx test preset-script` to execute the unit tests via [Jest](https://jestjs.io).
