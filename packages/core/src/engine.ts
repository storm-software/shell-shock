...
import type { EngineContext, PowerlinesEngine } from "@powerlines/engine";
import { createEngine as createPowerlines } from "@powerlines/engine";
import type {
  BuildInlineConfig,
  CleanInlineConfig,
  DocsInlineConfig,
...
export class Engine {
   ...
   */
  public static async from(options: EngineOptions): Promise<Engine> {
  ...
  private constructor(powerlines: PowerlinesEngine) {
