...
```bash
pnpm add -D @shell-shock/plugin-theme
```
...
```bash
npm install -D @shell-shock/plugin-theme
```
...
```bash
yarn add -D @shell-shock/plugin-theme
```
...
Run `nx test plugin-theme` to execute the unit tests via [Jest](https://jestjs.io).
