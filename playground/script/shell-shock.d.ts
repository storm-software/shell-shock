...
declare module "shell-shock:env" {
  ...
  export interface UnprefixedEnv {
     ...
     *
     * @readonly
     * @defaultValue "playground-script"
     */
     ...
     *
     * @readonly
     * @defaultValue "4dda57ce-d297-49d0-849e-8a8f84923212"
     */
     ...
     *
     * @readonly
     * @defaultValue "2026-04-29T14:05:57.480Z"
     */
     ...
     *
     * @readonly
     * @defaultValue "da57ced2-9709-4004-9e8a-8f84923212fe"
     */
     ...
     *
     * @readonly
     * @defaultValue "playground-script@0.0.1"
     */
  ...
  export interface Env extends UnprefixedEnv {
     ...
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_false: UnprefixedEnv["false"];
    /**
     * Enable verbose output.
     *
     * @title Verbose
     ...
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_VERBOSE: UnprefixedEnv["VERBOSE"];
    /**
     * Enable colored terminal output.
     *
     * @title Color
     ...
     *
     */
    PLAYGROUND_SCRIPT_COLOR: UnprefixedEnv["COLOR"];
    /**
     * Do not display the application banner displayed while running the CLI - will be set to true if running in a CI pipeline.
     *
     * @title Hide Banner
     ...
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_NO_BANNER: UnprefixedEnv["NO_BANNER"];
    /**
     * The system PATHEXT variable, used to determine which file extensions are considered executable on Windows.
     *
     * @internal
     ...
     *
     */
    PLAYGROUND_SCRIPT_PATHEXT: UnprefixedEnv["PATHEXT"];
    /**
     * The system PATH variable, used to locate executable files.
     *
     * @internal
     ...
     *
     */
    PLAYGROUND_SCRIPT_PATH: UnprefixedEnv["PATH"];
    /**
     * The npm user agent string, which can be used to detect if the environment is running within an npm script.
     *
     * @internal
     ...
     *
     */
    PLAYGROUND_SCRIPT_npm_config_user_agent: UnprefixedEnv["npm_config_user_agent"];
    /**
     * The npm_config_fund environment variable, which can be used to control npm's funding behavior.
     *
     * @internal
     ...
     *
     */
    PLAYGROUND_SCRIPT_npm_config_fund: UnprefixedEnv["npm_config_fund"];
    /**
     * The npm execution path, which can be used to determine the location of the npm executable.
     *
     * @internal
     ...
     *
     */
    PLAYGROUND_SCRIPT_npm_execpath: UnprefixedEnv["npm_execpath"];
    /**
     * The COMSPEC environment variable, which specifies the command-line interpreter to use on Windows.
     *
     * @internal
     ...
     *
     */
    PLAYGROUND_SCRIPT_COMSPEC: UnprefixedEnv["COMSPEC"];
    /**
     * The name of the application.
     *
     * @readonly
     * @defaultValue "playground-script"
     */
    readonly PLAYGROUND_SCRIPT_APP_NAME: UnprefixedEnv["APP_NAME"];
    /**
     * The version of the application.
     *
     * @readonly
     * @defaultValue "0.0.1"
     */
    readonly PLAYGROUND_SCRIPT_APP_VERSION: UnprefixedEnv["APP_VERSION"];
    /**
     * The unique identifier for the build.
     *
     * @readonly
     * @defaultValue "4dda57ce-d297-49d0-849e-8a8f84923212"
     */
    readonly PLAYGROUND_SCRIPT_BUILD_ID: UnprefixedEnv["BUILD_ID"];
    /**
     * The timestamp the build was ran at.
     *
     * @readonly
     * @defaultValue "2026-04-29T14:05:57.480Z"
     */
    readonly PLAYGROUND_SCRIPT_BUILD_TIMESTAMP: UnprefixedEnv["BUILD_TIMESTAMP"];
    /**
     * A checksum hash created during the build.
     *
     * @readonly
     *
     */
    readonly PLAYGROUND_SCRIPT_BUILD_CHECKSUM: UnprefixedEnv["BUILD_CHECKSUM"];
    /**
     * The unique identifier for the release.
     *
     * @readonly
     * @defaultValue "da57ced2-9709-4004-9e8a-8f84923212fe"
     */
    readonly PLAYGROUND_SCRIPT_RELEASE_ID: UnprefixedEnv["RELEASE_ID"];
    /**
     * The tag for the release. This is generally in the format of "\<APP_NAME\>\@\<APP_VERSION\>".
     *
     * @readonly
     * @defaultValue "playground-script@0.0.1"
     */
    readonly PLAYGROUND_SCRIPT_RELEASE_TAG: UnprefixedEnv["RELEASE_TAG"];
    /**
     * The name of the organization that maintains the application.
     *
     * @alias ORG
     * @defaultValue "storm-software"
     */
    PLAYGROUND_SCRIPT_ORGANIZATION: UnprefixedEnv["ORGANIZATION"];
    /**
     * The platform for which the application was built.
     *
     * @defaultValue "node"
     */
    PLAYGROUND_SCRIPT_PLATFORM: UnprefixedEnv["PLATFORM"];
    /**
     * The mode in which the application is running.
     *
     * @alias NODE_ENV
     ...
     * @defaultValue "development"
     */
    PLAYGROUND_SCRIPT_MODE: UnprefixedEnv["MODE"];
    /**
     * The environment the application is running in. This value will be populated with the value of `MODE` if not provided.
     *
     * @defaultValue "development"
     */
    PLAYGROUND_SCRIPT_ENVIRONMENT: UnprefixedEnv["ENVIRONMENT"];
    /**
     * Indicates if the application is running in debug mode.
     *
     * @defaultValue true
     */
    PLAYGROUND_SCRIPT_DEBUG: UnprefixedEnv["DEBUG"];
    /**
     * An indicator that specifies the current runtime is a test environment.
     *
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_TEST: UnprefixedEnv["TEST"];
    /**
     * An indicator that specifies the current runtime is a minimal environment.
     *
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_MINIMAL: UnprefixedEnv["MINIMAL"];
    /**
     * An indicator that specifies the current runtime is a no color environment.
     *
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_NO_COLOR: UnprefixedEnv["NO_COLOR"];
    /**
     * An indicator that specifies the current runtime is a force color environment.
     *
     * @defaultValue 3
     */
    PLAYGROUND_SCRIPT_FORCE_COLOR: UnprefixedEnv["FORCE_COLOR"];
    /**
     * An indicator that specifies the current runtime should force hyperlinks in terminal output.
     *
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_FORCE_HYPERLINK: UnprefixedEnv["FORCE_HYPERLINK"];
    /**
     * The name of the agent running the application. This variable is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_AGENT_NAME: UnprefixedEnv["AGENT_NAME"];
    /**
     * The color terminal type. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_COLORTERM: UnprefixedEnv["COLORTERM"];
    /**
     * The terminal type. This variable is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TERM: UnprefixedEnv["TERM"];
    /**
     * The terminal program name. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TERM_PROGRAM: UnprefixedEnv["TERM_PROGRAM"];
    /**
     * The terminal program version. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TERM_PROGRAM_VERSION: UnprefixedEnv["TERM_PROGRAM_VERSION"];
    /**
     * The terminal emulator name. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TERMINAL_EMULATOR: UnprefixedEnv["TERMINAL_EMULATOR"];
    /**
     * The terminal emulator session ID. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_WT_SESSION: UnprefixedEnv["WT_SESSION"];
    /**
     * An indicator that specifies the current terminal is running Terminus Sublime. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TERMINUS_SUBLIME: UnprefixedEnv["TERMINUS_SUBLIME"];
    /**
     * The ConEmu task name. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_ConEmuTask: UnprefixedEnv["ConEmuTask"];
    /**
     * The cursor trace ID. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CURSOR_TRACE_ID: UnprefixedEnv["CURSOR_TRACE_ID"];
    /**
     * The VTE version. This variable is set by certain terminal emulators.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_VTE_VERSION: UnprefixedEnv["VTE_VERSION"];
    /**
     * Indicates if error stack traces should be captured.
     *
     * @defaultValue true
     */
    PLAYGROUND_SCRIPT_STACKTRACE: UnprefixedEnv["STACKTRACE"];
    /**
     * Indicates if error data should be included.
     *
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_INCLUDE_ERROR_DATA: UnprefixedEnv["INCLUDE_ERROR_DATA"];
    /**
     * A web page to lookup error messages and display additional information given an error code.
     *
     * @title Error Details URL
     * @defaultValue "https://developer.stormsoftware.com/static/errors"
     */
    PLAYGROUND_SCRIPT_ERROR_URL: UnprefixedEnv["ERROR_URL"];
    /**
     * The default timezone for the application.
     *
     * @defaultValue "America/New_York"
     */
    PLAYGROUND_SCRIPT_DEFAULT_TIMEZONE: UnprefixedEnv["DEFAULT_TIMEZONE"];
    /**
     * The default locale to be used in the application.
     *
     * @defaultValue "en-US"
     */
    PLAYGROUND_SCRIPT_DEFAULT_LOCALE: UnprefixedEnv["DEFAULT_LOCALE"];
    /**
     * The default lowest log level to accept. If `null`, the logger will reject all records.
     *
     * @defaultValue "debug"
     */
    PLAYGROUND_SCRIPT_LOG_LEVEL: UnprefixedEnv["LOG_LEVEL"];
    /**
     * An indicator that specifies the current runtime is a continuous integration environment.
     *
     * @title Continuous Integration
     ...
     * @defaultValue false
     */
    PLAYGROUND_SCRIPT_CI: UnprefixedEnv["CI"];
    /**
     * The unique identifier for the current run. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_RUN_ID: UnprefixedEnv["RUN_ID"];
    /**
     * The agola git reference. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_AGOLA_GIT_REF: UnprefixedEnv["AGOLA_GIT_REF"];
    /**
     * The appcircle build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_AC_APPCIRCLE: UnprefixedEnv["AC_APPCIRCLE"];
    /**
     * The appveyor build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_APPVEYOR: UnprefixedEnv["APPVEYOR"];
    /**
     * The codebuild build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CODEBUILD: UnprefixedEnv["CODEBUILD"];
    /**
     * The task force build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TF_BUILD: UnprefixedEnv["TF_BUILD"];
    /**
     * The bamboo plan key. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_bamboo_planKey: UnprefixedEnv["bamboo_planKey"];
    /**
     * The bitbucket commit. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_BITBUCKET_COMMIT: UnprefixedEnv["BITBUCKET_COMMIT"];
    /**
     * The bitrise build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_BITRISE_IO: UnprefixedEnv["BITRISE_IO"];
    /**
     * The buddy workspace ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_BUDDY_WORKSPACE_ID: UnprefixedEnv["BUDDY_WORKSPACE_ID"];
    /**
     * The buildkite build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_BUILDKITE: UnprefixedEnv["BUILDKITE"];
    /**
     * The circleci build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CIRCLECI: UnprefixedEnv["CIRCLECI"];
    /**
     * The cirrus-ci build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CIRRUS_CI: UnprefixedEnv["CIRRUS_CI"];
    /**
     * The cf build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CF_BUILD_ID: UnprefixedEnv["CF_BUILD_ID"];
    /**
     * The cm build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CM_BUILD_ID: UnprefixedEnv["CM_BUILD_ID"];
    /**
     * The ci name. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CI_NAME: UnprefixedEnv["CI_NAME"];
    /**
     * The drone build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_DRONE: UnprefixedEnv["DRONE"];
    /**
     * The dsari build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_DSARI: UnprefixedEnv["DSARI"];
    /**
     * The earthly build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_EARTHLY_CI: UnprefixedEnv["EARTHLY_CI"];
    /**
     * The eas build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_EAS_BUILD: UnprefixedEnv["EAS_BUILD"];
    /**
     * The gerrit project. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_GERRIT_PROJECT: UnprefixedEnv["GERRIT_PROJECT"];
    /**
     * The gitea actions build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_GITEA_ACTIONS: UnprefixedEnv["GITEA_ACTIONS"];
    /**
     * The github actions build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_GITHUB_ACTIONS: UnprefixedEnv["GITHUB_ACTIONS"];
    /**
     * The gitlab ci build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_GITLAB_CI: UnprefixedEnv["GITLAB_CI"];
    /**
     * The go cd build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_GOCD: UnprefixedEnv["GOCD"];
    /**
     * The builder output build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_BUILDER_OUTPUT: UnprefixedEnv["BUILDER_OUTPUT"];
    /**
     * The harness build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_HARNESS_BUILD_ID: UnprefixedEnv["HARNESS_BUILD_ID"];
    /**
     * The jenkins url. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_JENKINS_URL: UnprefixedEnv["JENKINS_URL"];
    /**
     * The layerci build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_LAYERCI: UnprefixedEnv["LAYERCI"];
    /**
     * The magnum build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_MAGNUM: UnprefixedEnv["MAGNUM"];
    /**
     * The netlify build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_NETLIFY: UnprefixedEnv["NETLIFY"];
    /**
     * The nevercode build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_NEVERCODE: UnprefixedEnv["NEVERCODE"];
    /**
     * The prow job ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_PROW_JOB_ID: UnprefixedEnv["PROW_JOB_ID"];
    /**
     * The release build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_RELEASE_BUILD_ID: UnprefixedEnv["RELEASE_BUILD_ID"];
    /**
     * The render build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_RENDER: UnprefixedEnv["RENDER"];
    /**
     * The sailci build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_SAILCI: UnprefixedEnv["SAILCI"];
    /**
     * The hudson build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_HUDSON: UnprefixedEnv["HUDSON"];
    /**
     * The screwdriver build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_SCREWDRIVER: UnprefixedEnv["SCREWDRIVER"];
    /**
     * The semaphore build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_SEMAPHORE: UnprefixedEnv["SEMAPHORE"];
    /**
     * The sourcehut build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_SOURCEHUT: UnprefixedEnv["SOURCEHUT"];
    /**
     * The spaceship build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_SPACESHIP_CI: UnprefixedEnv["SPACESHIP_CI"];
    /**
     * The strider build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_STRIDER: UnprefixedEnv["STRIDER"];
    /**
     * The task ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TASK_ID: UnprefixedEnv["TASK_ID"];
    /**
     * The teamcity version. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TEAMCITY_VERSION: UnprefixedEnv["TEAMCITY_VERSION"];
    /**
     * The travis build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_TRAVIS: UnprefixedEnv["TRAVIS"];
    /**
     * The vela build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_VELA: UnprefixedEnv["VELA"];
    /**
     * The now builder build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_NOW_BUILDER: UnprefixedEnv["NOW_BUILDER"];
    /**
     * The appcenter build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_APPCENTER_BUILD_ID: UnprefixedEnv["APPCENTER_BUILD_ID"];
    /**
     * The xcode project build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_CI_XCODE_PROJECT: UnprefixedEnv["CI_XCODE_PROJECT"];
    /**
     * The xcode server build ID. This value is set by certain CI/CD systems.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_XCS: UnprefixedEnv["XCS"];
    /**
     * The application's runtime data directory.
     *
     * @title Data Directory
     ...
     *
     */
    PLAYGROUND_SCRIPT_DATA_DIR: UnprefixedEnv["DATA_DIR"];
    /**
     * The application's configuration data directory.
     *
     * @title Configuration Directory
     ...
     *
     */
    PLAYGROUND_SCRIPT_CONFIG_DIR: UnprefixedEnv["CONFIG_DIR"];
    /**
     * The application's cached data directory.
     *
     * @title Cache Directory
     ...
     *
     */
    PLAYGROUND_SCRIPT_CACHE_DIR: UnprefixedEnv["CACHE_DIR"];
    /**
     * The application's logging directory.
     *
     * @title Log Directory
     ...
     *
     */
    PLAYGROUND_SCRIPT_LOG_DIR: UnprefixedEnv["LOG_DIR"];
    /**
     * The application's temporary data directory.
     *
     * @title Temporary Directory
     ...
     *
     */
    PLAYGROUND_SCRIPT_TEMP_DIR: UnprefixedEnv["TEMP_DIR"];
    /**
     * A variable that specifies the current user's local application data directory on Windows.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_LOCALAPPDATA: UnprefixedEnv["LOCALAPPDATA"];
    /**
     * A variable that specifies the application data directory on Windows.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_APPDATA: UnprefixedEnv["APPDATA"];
    /**
     * A variable that specifies the data path in the home directory on Linux systems using the XDG base directory specification.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_XDG_DATA_HOME: UnprefixedEnv["XDG_DATA_HOME"];
    /**
     * A variable that specifies the configuration path in the home directory on Linux systems using the XDG base directory specification.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_XDG_CONFIG_HOME: UnprefixedEnv["XDG_CONFIG_HOME"];
    /**
     * A variable that specifies the cache path in the home directory on Linux systems using the XDG base directory specification.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_XDG_CACHE_HOME: UnprefixedEnv["XDG_CACHE_HOME"];
    /**
     * A variable that specifies the state directory on Linux systems using the XDG base directory specification.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_XDG_STATE_HOME: UnprefixedEnv["XDG_STATE_HOME"];
    /**
     * A variable that specifies the runtime directory on Linux systems using the XDG base directory specification.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_XDG_RUNTIME_DIR: UnprefixedEnv["XDG_RUNTIME_DIR"];
    /**
     * A variable that specifies the [Devenv](https://devenv.sh/) runtime directory.
     *
     * @readonly
     ...
     *
     */
    readonly PLAYGROUND_SCRIPT_DEVENV_RUNTIME: UnprefixedEnv["DEVENV_RUNTIME"];
    /**
     * Show the version of the application.
     *
     * @title Version
...
declare module "shell-shock:state" {
  ...
  > {
    /**
     * The full command path as a string. For example, if the user runs `playground-script foo bar`, this would be `foo bar`. This is useful for commands that need to know their full invocation path, such as for help text or for commands that have dynamic behavior based on their position in the command hierarchy.
     */
    path: string;
    /**
     * An array of command path segments. For example, if the user runs `playground-script foo bar`, this would be `["foo", "bar"]`. This is useful for commands that need to know their individual path segments, such as for dynamic routing or for commands that have behavior based on specific segments in the command hierarchy.
     */
    segments: string[];
    /**
...
/**
 * A collection of utility functions that assist in displaying help information for the Playground Script command-line interface application.
 *
...
/**
 * A collection of utility functions that assist in displaying help information for the Remove command.
 *
...
declare module "shell-shock:banner" {
  /**
   * Write the Playground Script command-line interface application banner for the Playground Script command to the console.
   *
