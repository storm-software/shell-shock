...
declare module "shell-shock:env" {
  ...
  export interface EnvBase {
     ...
     *
     * @readonly
     * @defaultValue "JOlKFlLvpqODoNTm-j8ZAIBFqGasCM8I"
     */
     ...
     *
     * @readonly
     * @defaultValue "48c221f3-5b22-4630-bfc6-bcbbb932a0b7"
     */
     ...
     *
     * @readonly
     * @defaultValue "2026-04-14T00:01:36.541Z"
     */
     ...
     *
     * @readonly
     * @defaultValue "c221f35b-2206-40ff-86bc-bbb932a0b74d"
     */
...
declare module "shell-shock:banner" {
  /**
   * Write the Playground Custom Commands Directory command-line interface application banner for the  command to the console.
   *
